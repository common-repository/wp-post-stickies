...
Donate link: https://podz.io/agilepress/products/wp-post-stickies/
...
== Changelog ==
= 1.93.8 =
* Changed readme to reflect new URLs

= 1.93.8 =
* Configured defaults when note settings are left empty.

= 1.91.9 =
* Setting the tilt is now an option instead of a default.

= 1.87.2 =
* Fixed a couple of bugs (one major, sorry!) with widgets. Dropped code for displaying notes from the pre-CPT version.
